...
<header>
    ...
    <img class='card-img-top img-fuid'  <?php if($valor['imagen']==NULL){ ?> src="<?php echo base_url();?>assets/img/nofoto.png"> <?php } else{?>   src="<?php echo base_url();?>assets/img/<?php echo $valor['imagen']  ?>"><?php } ?>
    <div class='card-block'>
    <h4 class='card-title'><?php echo $valor['titulo']?></h4>
    <p class='card-text'></p>
    <a href='<?php echo base_url();?>index.php/noticias/leer/<?php echo $valor["idnoticia"];?>' class='btn btn-primary'>Leer</a>
     </div>
     </div>
