...
<h2 style="margin-left: 21%" class="text-primary">Registro Usuario</h2>
...
<form >
 ...
 <div class="form-group">
    ...
    <select name="rol" id="rol" class="form-control col-sm-5">
      <option value="validador" <?php echo  set_select('rol', 'validador'); ?>>Validador</option>
      <option value="editor" <?php echo  set_select('rol', 'editor'); ?>>Editor</option>
      <option value="ambos" <?php echo  set_select('rol', 'ambos'); ?>>Ambos</option>
    </select>
    </div>
